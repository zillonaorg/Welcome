...
```
cd existing_repo
git remote add origin https://gitlab.com/zillona-dojo/welcome.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/zillona-dojo/welcome/-/settings/integrations)
